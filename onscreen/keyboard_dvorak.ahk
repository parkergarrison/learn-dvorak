...
k_scale = 3
k_KeyWidth = %k_FontSize% * %k_scale%
k_KeyWidth *= 3
k_KeyHeight = %k_FontSize% * %k_scale%
k_KeyHeight *= 3
k_KeyMargin = %k_FontSize% * %k_scale%
k_KeyMargin /= 6
k_SpacebarWidth = %k_FontSize% * %k_scale%
k_SpacebarWidth *= 25
k_KeyWidthHalf = %k_KeyWidth% * %k_scale%
k_KeyWidthHalf /= 2
